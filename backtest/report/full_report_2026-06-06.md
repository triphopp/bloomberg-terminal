...
| `g12_composite` | 1000 | 27% | +8pp | 90% | 42% | 2.0d | 🟡 SENSITIVE |
...
| `g7_price_zscore` | 1925 | 18% | -1pp | 99% | 30% | 2.0d | ❌ WEAK |
...
| `g12_composite` | 1000 | 7% | +3pp | 100% | 14% | 2.0d | ❌ WEAK |
...
| `g12_composite` | 1000 | 1% | +0pp | 100% | 2% | 2.5d | ❌ WEAK |
...
| `g7_price_zscore` | 1925 | 1% | -0pp | 100% | 1% | 2.5d | ❌ WEAK |
| `g7_rsi_oversold` | 192 | 5% | +4pp | 80% | 9% | 3.0d | ❌ WEAK |
| `g8_layer_a_bearish` | 598 | 2% | +1pp | 80% | 3% | 3.0d | ❌ WEAK |
| `g9_crisis_composite_red` | 0 | 0% | -1pp | 0% | 0% | n/ad | ❌ WEAK |
...
| `g12_composite` | 1000 | 11% | +4pp | 80% | 19% | 1.0d | ❌ WEAK |
...
| `g12_composite` | 1000 | 38% | +8pp | 91% | 54% | 3.0d | 🟡 SENSITIVE |
...
| `g12_composite` | 444 | 9% | -0pp | 94% | 16% | 2.5d | ❌ WEAK |
...
| `g7_price_zscore` | 462 | 9% | +0pp | 100% | 17% | 2.0d | ❌ WEAK |
...
| `g12_composite` | 444 | 0% | +0pp | 0% | 0% | n/ad | — NO_EVENTS |
...
| `g7_price_zscore` | 462 | 0% | +0pp | 0% | 0% | n/ad | — NO_EVENTS |
...
| `g12_composite` | 141 | 28% | +9pp | 75% | 40% | 2.0d | 🟡 SENSITIVE |
...
| `g7_price_zscore` | 334 | 18% | -1pp | 96% | 30% | 2.0d | ❌ WEAK |
...
| `g12_composite` | 141 | 5% | +2pp | 100% | 9% | 2.0d | ❌ WEAK |
...
| `g7_price_zscore` | 334 | 2% | -0pp | 100% | 4% | 2.0d | ❌ WEAK |
...
| `g12_composite` | 🟡 SENSITIVE | ❌ WEAK | 🟡 SENSITIVE | ❌ NO |
...
| `g9_crisis_composite_red` | ❌ WEAK | ❌ WEAK | ❌ WEAK | ❌ NO |
