    ...
    <div className="flex flex-wrap items-center gap-4 px-3 py-1.5 border-b text-[10px] font-mono"
      ...
      <div>
        ...
        <span className="font-bold text-xs" style={{ color: pnlColor(totalPnl) }}>
          {sym}{fmtK(Math.abs(totalPnl))} {totalPnl >= 0 ? "▲" : "▼"}
        </span>
      </div>
      <div>
      ...
      <div className="ml-auto text-[8px] px-2 py-0.5 border font-bold animate-pulse"
